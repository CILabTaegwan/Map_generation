...
class Workspace(object):
    ...
    def rand_position(self,num_items,layout,tmp_num):
        ...
        while True:
            ...
            base_arr = np.array([2,3,4,5]).astype(int)#6~8
            while True:
            ...
            if len(rooms)!=1:
                continue
            if tmp_num==1:
                if len(new_layout[new_layout == 0]) < 11:
                    continue
            else:
    ...
    def run_testmap(self):
        ...
        for j in range(len(self.hamming_list_test)-tmp_index,len(self.hamming_list_test)):
            ...
            if len(self.map_list_test) == 50:
                break
    def main(self):
        while len(self.map_list)<550:
            self.run()
